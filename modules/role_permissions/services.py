...
async def assign_permission_to_role(db: AsyncSession, role_id: str, permission_id: str) -> Role:
    """
...
async def remove_permission_from_role(db: AsyncSession, role_id: str, permission_id: str) -> Role:
    """
...
async def get_role_permissions(db: AsyncSession, role_id: str) -> RSRolePermissions:
    ...
    for permission_uid in role.permissions:
        try:
            ...
            permissions.append(RSPermissionDetail(
                uid=permission.uid,
