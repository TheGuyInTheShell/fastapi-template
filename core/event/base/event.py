    ...
    def run(self, *args, **kwargs) -> "Event":
        ...
        try:
            ...
            if asyncio.get_event_loop().is_running():
                ...
                asyncio.ensure_future(self.channelRef._iterator(self, lambda *args, **kwargs: None, *self.event_args, **self.events_kwargs))
            else:

                asyncio.run(self.channelRef._iterator(self, lambda *args, **kwargs: None, *self.event_args, **self.events_kwargs))
